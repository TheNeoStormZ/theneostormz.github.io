const INFO = {
	...
	about: {
		title: "Pablo Marín Gómez - Entusiasta de la tecnología ",
		description:
	...
	projects: [
...

		{
			title: "FoodCheck",
			description:
				"FoodCheck es una PWA que permite a los usuarios filtrar y comparar productos alimenticios según sus preferencias, dietas e intolerancias.",
